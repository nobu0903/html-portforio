...
eaten_text = font.render("Burger Eaten: " + str(burgers_eaten), True, ORANGE)
...
while running:
    ...
    #Move the burger and updatae burger points
    ...
    if burger_rect.y > WINDOW_HEIGHT:
        ...
        burger_rect.topright = (random.randint(0, WINDOW_WIDTH - 32), -BUFFER_DISTANCE)
        burger_velocity = STARTING_BURGER_VELOCITY
    ...
    if player_lives == 0:
        ...
        #pase the game until player press any keys
